...
AI Assistance
The serial code structure, documentation guidance, and explanation sections were prepared with assistance from ChatGPT (OpenAI). The exact prompts used are listed in the file prompts/serial.md
